...
export default function TermosPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <h1 className="mt-4 text-2xl font-bold text-tinta">Termos de uso</h1>
      ...
      <div className="mt-6 space-y-5 text-sm leading-relaxed text-tinta2">
        <section>
          <h2 className="text-base font-bold text-tinta">1. O que o Aliquo faz</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="text-base font-bold text-tinta">2. O que o Aliquo não é</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="text-base font-bold text-tinta">3. Responsabilidade pela classificação</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="text-base font-bold text-tinta">4. Limites dos dados</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="text-base font-bold text-tinta">5. Limitação de responsabilidade</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="text-base font-bold text-tinta">6. Conta e uso</h2>
          <p className="mt-1">
