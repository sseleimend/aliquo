...
do repositório, nunca aqui dentro. O resto dos comandos roda a partir desta
pasta (`apps/simulador`):
...
Ou, da raiz do repo: `npm run dev` (atalho para `npm run dev
--workspace=apps/simulador`).
